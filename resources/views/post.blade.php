...
@section('container')
   ...
   <p>By. <a href="#" class="font-medium text-blue-800 dark:text-blue-600 hover:underline">{{ $post->user->name }} </a> In <a href="/categories/{{ $post->category->slug }}" class="font-medium text-blue-800 dark:text-blue-600 hover:underline">{{ $post->category->name }}</a></p>
